...
export default function GabahPage() {
  ...
  async function kirimKeDatabase() {
    ...
    const konfirmasi =
      ...
      `Data akan masuk sebagai PANEN PADI 50:50.\n` +
    ...
    try {
      ...
      const persenOwner = 50;
      const persenPenggarap = 50;
      ...
      const { error } = await supabase.from("harvests").insert({
        ...
        catatan: `[DARI GABAH] ${hasil.totalJumlah} sak, ${sesi.length} sesi timbang`,
      });
  ...
  async function saveAsImage() {
    ...
    try {
      ...
      alert(
        "⚠️ Gagal simpan gambar. Coba screenshot manual dari browser ya."
      );
    }
  }
              ...
              <div className="mb-5">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-2 text-sm">
                  ...
                  {hasil.bobotPribadi > 0 && (
                    <div className="flex justify-between pt-1 text-xs text-orange-700 bg-orange-50 -mx-4 px-4 py-2 rounded">
